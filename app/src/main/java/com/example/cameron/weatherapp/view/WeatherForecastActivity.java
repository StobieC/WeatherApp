...
import com.example.cameron.weatherapp.model.adapter.WeatherForecastAdapter;
...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        currentConditionForecastCity = (TextView) findViewById(R.id.forecastCurrentCity);
        currentConditionForecastCity.setText(cityName);
