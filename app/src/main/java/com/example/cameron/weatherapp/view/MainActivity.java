...
import com.example.cameron.weatherapp.controller.service.ForecastHandlerService;
...
public class MainActivity extends Activity implements WeatherForecastInterface {
    ...
    private Button addCityBtn = null;
    ...
    private void initialize() {
        ...
        addCityBtn = (Button) this.findViewById(R.id.addNewBtn);
